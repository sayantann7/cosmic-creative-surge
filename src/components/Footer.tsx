        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-adastra-red transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services/strategy" className="text-gray-400 hover:text-adastra-red transition-colors duration-300">Strategic Consulting</Link></li>
              <li><Link to="/services/creative" className="text-gray-400 hover:text-adastra-red transition-colors duration-300">Creative Design</Link></li>
              <li><Link to="/services/web" className="text-gray-400 hover:text-adastra-red transition-colors duration-300">Web Development</Link></li>
              <li><Link to="/services/marketing" className="text-gray-400 hover:text-adastra-red transition-colors duration-300">Digital Marketing</Link></li>
              <li><Link to="/services/seo" className="text-gray-400 hover:text-adastra-red transition-colors duration-300">SEO & Analytics</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">123 Cosmic Way, Digital Universe</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-adastra-red flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">email@adastramedia.com</span>
              </li>
            </ul>
          </div>
        </div>
